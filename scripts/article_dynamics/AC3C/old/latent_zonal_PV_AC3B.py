...
ax1.scatter(traj0['lon'], traj0['lat'], color = 'black', marker = '+', linewidths = 1, transform=ccrs.PlateCarree(), alpha = 1)#, alpha = 0.3)
...
plt.savefig(f'{path_plots}/latent_zonal_article_zonal_PV_{dataset}_{cyc}.png', bbox_inches='tight', transparent = True)
plt.show()
