...
traj0 = traj.isel(time_ind = time_ind)#.sel(n_seeds =n_seeds_friction)
...
ax2.scatter(traj0['lat'], traj0['P'] / 100, color = 'black', marker = '+', linewidths = 1, alpha = 0.5)
...
plt.savefig(f'{path_plots}/friction_article_{dataset}_{cyc}.png', bbox_inches='tight', transparent = True)
plt.show()
