...
traj0 = traj0.where(PV_dot_heating_lat0 * 3600 * 1e6 <= threshold  )
...
plt.savefig(f'{path_plots}/latent_neg_article_PV_time_ind{time_ind}_{dataset}_{cyc}.png', bbox_inches='tight', transparent = True)
plt.show()
