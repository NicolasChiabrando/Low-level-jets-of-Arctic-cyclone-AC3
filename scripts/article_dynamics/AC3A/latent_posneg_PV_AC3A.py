...
print(f'{path_plots}/latent_posneg_article_PV_{time_cs}_{dataset}_{cyc}.png')
plt.savefig(f'{path_plots}/latent_posneg_article_PV_ind{time_ind}_{dataset}_{cyc}.png', bbox_inches='tight', transparent = True)
plt.show()
