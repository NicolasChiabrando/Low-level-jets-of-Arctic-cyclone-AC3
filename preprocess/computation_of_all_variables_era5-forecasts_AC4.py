...
path_u = f"{root_input}/Data/{dataset}/ERA5_U_all_levels_2022-08-{day}_18:00:00_50N-90N.nc"
path_v = f"{root_input}/Data/{dataset}/ERA5_V_all_levels_2022-08-{day}_18:00:00_50N-90N.nc"
path_w = f"{root_input}/Data/{dataset}/ERA5_Omega_all_levels_2022-08-{day}_18:00:00_50N-90N.nc"
path_t = f"{root_input}/Data/{dataset}/ERA5_TEMP_all_levels_2022-08-{day}_18:00:00_50N-90N.nc"
...
path_ovap = f"{root_input}/Data/{dataset}/ERA5_OVAP_all_levels_2022-08-{day}_18:00:00_50N-90N.nc" #sueuERA5_OVAP_all_levels_2022-08-22_18:00:00_50N-90N.nc" #
path_geop = f"{root_input}/Data/{dataset}/ERA5_GEOP_all_levels_2022-08-{day}_18:00:00_50N-90N.nc"
path_cldr = f"{root_input}/Data/{dataset}/ERA5_CDR_all_levels_2022-08-{day}_18:00:00_50N-90N.nc"
...
cldr = xr.open_dataset(path_cldr, chunks=chunks)['cc'].rename({'valid_time': 'time'}).rename({'model_level': 'level'})  # kg/kg
#sp = xr.open_dataset(path_sp, chunks=chunks)[var_sp].rename({'valid_time': 'time'}) # Pa
#ovap = ovap.sel(time = slice(np.min(u['time']).values, np.max(u['time']).values))
#geop = geop.sel(time = slice(np.min(u['time']).values, np.max(u['time']).values))
...
path_MTTPM  = f"{root_input}/Data/{dataset}/ERA5_MTTPM_all_levels_2022-08-{day}_18:00:00_50N-90N.nc"
path_MUTPM = f"{root_input}/Data/{dataset}/ERA5_MUTPM_all_levels_2022-08-{day}_18:00:00_50N-90N.nc"
path_MVTPM = f"{root_input}/Data/{dataset}/ERA5_MVTPM_all_levels_2022-08-{day}_18:00:00_50N-90N.nc"

path_MTTLWR  = f"{root_input}/Data/{dataset}/ERA5_MTTLWR_all_levels_2022-08-{day}_18:00:00_50N-90N.nc"
path_MTTSWR  = f"{root_input}/Data/{dataset}/ERA5_MTTSWR_all_levels_2022-08-{day}_18:00:00_50N-90N.nc"
path_MTTLWRCS  = f"{root_input}/Data/{dataset}/ERA5_MTTLWRCS_all_levels_2022-08-{day}_18:00:00_50N-90N.nc"
path_MTTSWRCS  = f"{root_input}/Data/{dataset}/ERA5_MTTSWRCS_all_levels_2022-08-{day}_18:00:00_50N-90N.nc"
...
#all_data_dt = xr.Dataset(
#    {
#        "pres": p,
#        "PV_1": q_1,
#        "PV_2": q_2,
#        "PV_3": q_3,
#        "PV_dot_heating": dqdt_heating,
#        "PV_dot_friction": dqdt_friction
#    }
#)



# all_data_dt.to_netcdf(f"{root_input}/Generated_data/data/{dataset}/PV/ERA5_forecasts_PV_tendencies_pres_all_levels_2022-08-{day}_50N-90N.nc")
# (all_data_dt.sel(latitude = slice(lat_max,lat_min), longitude = slice(lon_min,lon_max))).to_netcdf(f"{root_input}/Generated_data/data/{dataset}/PV/ERA5_forecasts_PV_tendencies_pres_all_levels_2022-08-{day}_{lat_min}N-{lat_max}N.nc")
#(sp.sel(latitude = slice(lat_max,lat_min), longitude = slice(lon_min,lon_max))).to_netcdf(f"{root_input}/Generated_data/data/{dataset}/ERA5_SP_2022-08-{day}_{lat_min}N-{lat_max}N.nc")
# p.close()
# q_1.close()
# q_2.close()
# q_3.close()
...
# print('all_data_dt done', file = sys.stderr)
#all_data_dt.close()

#friction_dt = xr.Dataset(
#    {
...
# friction_dt.to_netcdf(f"{root_input}/Generated_data/data/{dataset}/PV/ERA5_forecasts_PV_tendencies_friction_all_levels_2022-08-{day}_50N-90N.nc")
# (friction_dt.sel(latitude = slice(lat_max,lat_min), longitude = slice(lon_min,lon_max))).to_netcdf(f"{root_input}/Generated_data/data/{dataset}/PV/ERA5_forecasts_PV_tendencies_friction_all_levels_2022-08-{day}_{lat_min}N-{lat_max}N.nc")
#friction_dt.close()

# print('frction_dt close', file = sys.stderr)

#heating_dt = xr.Dataset(
#    {
...
# heating_dt.to_netcdf(f"{root_input}/Generated_data/data/{dataset}/PV/ERA5_forecasts_PV_tendencies_heating_all_levels_2022-08-{day}_50N-90N.nc")
# (heating_dt.sel(latitude = slice(lat_max,lat_min), longitude = slice(lon_min,lon_max))).to_netcdf(f"{root_input}/Generated_data/data/{dataset}/PV/ERA5_forecasts_PV_tendencies_heating_all_levels_2022-08-{day}_{lat_min}N-{lat_max}N.nc")
