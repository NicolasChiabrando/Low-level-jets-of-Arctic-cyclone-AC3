...
# path_sp1 = f"{root_input}/Data/{dataset}/ERA5_SP_2022-08-15_18:00:00_50N-90N.nc"
# path_sp2 = f"{root_input}/Data/{dataset}/ERA5_SP_2022-08-16_06:00:00_50N-90N.nc"
#
#
# sp1 = xr.open_dataset(path_sp1, chunks = chunks)['sp']
# sp2 = xr.open_dataset(path_sp2, chunks = chunks)['sp']
#
# sp = xr.concat([sp1, sp2], dim='valid_time')
#
# sp = sp.rename({'valid_time': 'time'}).sel(latitude = slice(lat_max, lat_min), longitude = slice(lon_min, lon_max) )
# sp.to_netcdf(f"{root_input}/Data/era5_forecasts/ERA5_SP_2022-08-{day}_{lat_min}N-{lat_max}N.nc")
...
all_variables.sel(latitude = slice(lat_max,lat_min), longitude = slice(lon_min,lon_max)).to_netcdf(f"{root_input}/Generated_data/data/{dataset}/ERA5_forecasts_all_pv_variables_all_levels_2022-08-{day}_{lat_min}N-{lat_max}N_all-long.nc")
