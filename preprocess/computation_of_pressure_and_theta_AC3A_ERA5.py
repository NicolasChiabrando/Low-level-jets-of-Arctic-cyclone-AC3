...
path_t1 = f"{data_folder}/ERA5_TEMP_all_levels_2022-08-15_18:00:00_50N-90N.nc"
path_t2 = f"{data_folder}/ERA5_TEMP_all_levels_2022-08-16_06:00:00_50N-90N.nc"
...
path_sp1 = f"{data_folder}/ERA5_SP_2022-08-15_18:00:00_50N-90N.nc"
path_sp2 = f"{data_folder}/ERA5_SP_2022-08-16_06:00:00_50N-90N.nc"

t1 = xr.open_dataset(path_t1)['t']
t2 = xr.open_dataset(path_t2)['t']

t = xr.concat([t1, t2], dim='valid_time')
...
theta.to_netcdf(f"{root_input}/Data/era5_forecasts/ERA5_theta_all_levels_2022-08-15a16_50N-90N.nc")
p_comp.to_netcdf(f"{root_input}/Data/era5_forecasts/ERA5_pres_all_levels_2022-08-15a16_50N-90N.nc")

sp.to_netcdf(f"{root_input}/Data/era5_forecasts/ERA5_SP_2022-08-15a16_{lat_min}N-{lat_max}N.nc")
