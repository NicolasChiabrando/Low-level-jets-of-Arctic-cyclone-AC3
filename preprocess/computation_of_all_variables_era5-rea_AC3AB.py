...
path_u = f"{root_input}/Data/{dataset}/ERA5_reanalyse_U_all_levels_15a19_50N-90N.nc"
path_v = f"{root_input}/Data/{dataset}/ERA5_reanalyse_V_all_levels_15a19_50N-90N.nc"
path_w = f"{root_input}/Data/{dataset}/ERA5_reanalyse_Omega_all_levels_15a19_50N-90N.nc"
path_t = f"{root_input}/Data/{dataset}/ERA5_reanalyse_TEMP_all_levels_15a19_50N-90N.nc"
path_p = f"{root_input}/Data/{dataset}/ERA5_reanalyse_pres_all_levels_15a19_50N-90N.nc"
path_sp = f"{root_input}/Data/{dataset}/ERA5_reanalyse_SP_15a19_50N-90N.nc"
path_theta = f"{root_input}/Data/{dataset}/ERA5_reanalyse_theta_all_levels_15a19_50N-90N.nc"

path_cldr = f"{root_input}/Data/{dataset}/ERA5_reanalyse_CDR_all_levels_15a19_50N-90N.nc"


var_u, var_v, var_w, var_t, var_p, var_theta, var_sp = 'u', 'v', 'w', 't', 'pres', 'theta', 'sp' #sometimes the variable for temperature is "temp" or "t"


path_MTTPM  = f"{root_input}/Data/era5_forecasts/ERA5_MTTPM_all_levels_2022-08-{day}_50N-90N.nc"
path_MUTPM = f"{root_input}/Data/era5_forecasts/ERA5_MUTPM_all_levels_2022-08-{day}_50N-90N.nc"
path_MVTPM = f"{root_input}/Data/era5_forecasts/ERA5_MVTPM_all_levels_2022-08-{day}_50N-90N.nc"

path_MTTLWR  = f"{root_input}/Data/era5_forecasts/ERA5_MTTLWR_all_levels_2022-08-{day}_50N-90N.nc"
path_MTTSWR  = f"{root_input}/Data/era5_forecasts/ERA5_MTTSWR_all_levels_2022-08-{day}_50N-90N.nc"
path_MTTLWRCS  = f"{root_input}/Data/era5_forecasts/ERA5_MTTLWRCS_all_levels_2022-08-{day}_50N-90N.nc"
path_MTTSWRCS  = f"{root_input}/Data/era5_forecasts/ERA5_MTTSWRCS_all_levels_2022-08-{day}_50N-90N.nc"
...
u = xr.open_dataset(path_u, chunks=chunks)[var_u].rename({'valid_time': 'time'}).rename({'model_level': 'level'}).sel(time = Fx['time'])  # .sel(longitude = slice(lon_min, lon_max)).sel(latitude = slice(lat_max, lat_min))
v = xr.open_dataset(path_v, chunks=chunks)[var_v].rename({'valid_time': 'time'}).rename({'model_level': 'level'}).sel(time = Fx['time'])  # .sel(longitude = slice(lon_min, lon_max)).sel(latitude = slice(lat_max, lat_min))
w = xr.open_dataset(path_w, chunks=chunks)[var_w].rename({'valid_time': 'time'}).rename({'model_level': 'level'}).sel(time = Fx['time'])  # .sel(longitude = slice(lon_min, lon_max)).sel(latitude = slice(lat_max, lat_min))
t = xr.open_dataset(path_t, chunks=chunks)[var_t].rename({'valid_time': 'time'}).rename({'model_level': 'level'}).sel(time = Fx['time'])  # .sel(longitude = slice(lon_min, lon_max)).sel(latitude = slice(lat_max, lat_min))
p = xr.open_dataset(path_p, chunks=chunks)[var_p].rename({'valid_time': 'time'}).rename({'model_level': 'level'}).sel(time = Fx['time'])  # Pa
theta = xr.open_dataset(path_theta, chunks=chunks)[var_theta].rename({'valid_time': 'time'}).rename({'model_level': 'level'}).sel(time = Fx['time'])  # K
...
path_sp = f"{root_input}/Data/ERA5/ERA5_reanalyse_SP_15a19_{lat_min}N-{lat_max}N.nc"
sp = xr.open_dataset(path_sp)['sp'].set(time = Fx['time'])
sp.to_netcdf(f"{root_input}/Data/ERA5/ERA5_reanalyse_SP_{day}_{lat_min}N-{lat_max}N.nc")