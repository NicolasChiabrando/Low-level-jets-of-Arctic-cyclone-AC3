...
data_folder= "/data/nchiab/PV/Data/ERA5/"

#path_t = f"{root_input}/Data/era5_forecasts/ERA5_TEMP_all_levels_2022-08-16_50N-90N.nc"
path_t = f"{data_folder}/ERA5_reanalys_TEMP_all_levels_15a19_50N-90N.nc"
...
path_sp = f"{data_folder}/ERA5_SP_2022-08-15a19_50N-90N.nc"


t = xr.open_dataset(path_t)['t']
...
theta.to_netcdf(f"{root_input}/Data/ERA5/ERA5_reanalyse_theta_all_levels_15a19_50N-90N.nc")
p_comp.to_netcdf(f"{root_input}/Data/ERA5/ERA5_reanalyse_pres_all_levels_15a19_50N-90N.nc")

sp.to_netcdf(f"{root_input}/Data/ERA5/ERA5_reanalyse_SP_15a19_{lat_min}N-{lat_max}N.nc")
