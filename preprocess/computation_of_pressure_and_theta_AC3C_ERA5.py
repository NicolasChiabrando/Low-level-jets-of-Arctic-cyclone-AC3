...
path_t1 = f"{data_folder}/ERA5_TEMP_all_levels_2022-08-19_06:00:00_50N-90N.nc"
path_t2 = f"{data_folder}/ERA5_TEMP_all_levels_2022-08-19_18:00:00_50N-90N.nc"
path_t3 = f"{data_folder}/ERA5_TEMP_all_levels_2022-08-20_06:00:00_50N-90N.nc"
path_t4 = f"{data_folder}/ERA5_TEMP_all_levels_2022-08-20_18:00:00_50N-90N.nc"
path_t5 = f"{data_folder}/ERA5_TEMP_all_levels_2022-08-21_06:00:00_50N-90N.nc"
path_t6 = f"{data_folder}/ERA5_TEMP_all_levels_2022-08-21_18:00:00_50N-90N.nc"
...
path_sp1 = f"{data_folder}/ERA5_SP_2022-08-19_06:00:00_50N-90N.nc"
path_sp2 = f"{data_folder}/ERA5_SP_2022-08-19_18:00:00_50N-90N.nc"
path_sp3 = f"{data_folder}/ERA5_SP_2022-08-20_06:00:00_50N-90N.nc"
path_sp4 = f"{data_folder}/ERA5_SP_2022-08-20_18:00:00_50N-90N.nc"
path_sp5 = f"{data_folder}/ERA5_SP_2022-08-21_06:00:00_50N-90N.nc"
path_sp6 = f"{data_folder}/ERA5_SP_2022-08-21_18:00:00_50N-90N.nc"

t1 = xr.open_dataset(path_t1)['t']
t2 = xr.open_dataset(path_t2)['t']
t3= xr.open_dataset(path_t3)['t']
t4 = xr.open_dataset(path_t4)['t']
t5= xr.open_dataset(path_t5)['t']
t6 = xr.open_dataset(path_t6)['t']

t = xr.concat([t1, t2, t3, t4, t5, t6], dim='valid_time')
...
sp5 = xr.open_dataset(path_sp5)['sp']
sp6 = xr.open_dataset(path_sp6)['sp']

sp = xr.concat([sp1, sp2, sp3, sp4, sp5, sp6], dim='valid_time')
...
theta.to_netcdf(f"{root_input}/Data/era5_forecasts/ERA5_theta_all_levels_2022-08-19a21_50N-90N.nc")
p_comp.to_netcdf(f"{root_input}/Data/era5_forecasts/ERA5_pres_all_levels_2022-08-19a21_50N-90N.nc")


sp.to_netcdf(f"{root_input}/Data/era5_forecasts/ERA5_SP_2022-08-19a21_{lat_min}N-{lat_max}N.nc")
